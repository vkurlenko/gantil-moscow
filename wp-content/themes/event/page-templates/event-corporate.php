...
<div>
	<div class="container clearfix insert-1">
	<?php iinclude_page(433, 'displayTitle=true&titleBefore=<h2 class="widget-title">'); ?>
	</div>
</div>
...
<div>
	<div class="container clearfix insert-1">
	<?php iinclude_page(186, 'displayTitle=true&titleBefore=<h2 class="widget-title">'); ?>
	</div>
</div>
