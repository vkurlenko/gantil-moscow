...
function event_our_speaker(){
	...
	//$event_settings['event_total_our_speaker'] = 6;
			...
			echo '<!-- Our Team Box ============================================= -->'; ?>
				...
				<div class="our-team-box">
					...
					<div class="container clearfix">
								...
								$event_our_speaker_get_featured_posts 		= new WP_Query(array(
									'posts_per_page'      	=> $event_settings['event_total_our_speaker'],
									'post_type'           	=> array('page'),
									'post__in'            	=> $event_our_speaker_list_page,
									'orderby'             	=> 'rand',
						...
						while ($event_our_speaker_get_featured_posts->have_posts()):$event_our_speaker_get_featured_posts->the_post();
							...
							<div class="four-column">
								...
								?>
									...
									{ 
										//echo htmlspecialchars_decode(esc_attr($event_settings['event_our_speaker_about_'. $i .'']));									
									} */									
									?>
								...
								/*if($event_settings['event_our_speaker_about_'. $i .''] != '') { ?>
									<div class="speaker-topic-title">
										...
										<!--<h4><?php echo $event_settings['event_our_speaker_about_'. $i .''];?></h4>-->
										<h4><a style="color:#ffffff" href="<?php the_permalink();?>">Записаться</a></h4>
									</div>
								<?php }*/ ?>
								
								<div class="speaker-topic-title">										
									<h4><a onclick="splite_loader(); return false" style="color:#ffffff" href="<?php the_permalink();?>">Записаться</a></h4>
								</div>
